...
SWIFT_MODULE_NAMESPACE_PUSH("India_Helper")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC12India_Helper11AppDelegate")
...
SWIFT_CLASS("_TtC12India_Helper14ViewController")
@interface ViewController : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate>
@property (nonatomic, weak) IBOutlet UISegmentedControl * _Null_unspecified mode;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified lakhField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified thousandField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified croreField;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lakhCurrencyLabel;
...
@property (nonatomic, copy) NSString * _Nonnull currentlySelectedRightCurrency;
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nonnull currentExchangeRates;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull leftCurrencies;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull rightCurrencies;
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView * _Nonnull)pickerView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)pickerView:(UIPickerView * _Nonnull)pickerView numberOfRowsInComponent:(NSInteger)component SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)pickerView:(UIPickerView * _Nonnull)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component SWIFT_WARN_UNUSED_RESULT;
- (IBAction)segmentControlOnTouchDown:(UISegmentedControl * _Nonnull)sender;
...
- (void)getExchangeRatesFromAPI;
- (IBAction)updateButtonOnClicked:(id _Nonnull)sender;
- (IBAction)infoButtonOnClicked:(id _Nonnull)sender;
- (void)unlockUpdateButtonWithWasSuccessfull:(BOOL)wasSuccessfull;
- (void)lockUpdateButton;
- (IBAction)thousandOnValueChanged:(UITextField * _Nonnull)sender forEvent:(UIEvent * _Nonnull)event;
- (IBAction)lakhOnValueChanged:(UITextField * _Nonnull)sender forEvent:(UIEvent * _Nonnull)event;
- (IBAction)millionOnValueChanged:(UITextField * _Nonnull)sender forEvent:(UIEvent * _Nonnull)event;
...
- (NSString * _Nonnull)convertToDisplayedFormatWithValue:(NSString * _Nonnull)value SWIFT_WARN_UNUSED_RESULT;
- (void)reset;
- (void)fromThousandWithValue:(NSString * _Nonnull)value;
- (void)fromLakhWithValue:(NSString * _Nonnull)value;
- (void)fromMillionWithValue:(NSString * _Nonnull)value;
